...
% 10.24
\begin{thSatz}[Satz von Arzel\`a-Ascoli] \label{vl27:arzelaascoli}
    ...
    \begin{enumerate}[(i)]
        ...
        \item \label{vl27:arzelaascoli:ii}
            $A$ ist \emph{gleichgradig stetig},\index{gleichgradig stetig} d.\,h.
...
\begin{thSatz}[Kompakte Mengen in $\Lpp(\R^n)$, Riesz-Fr\'echet-Kolmogorov]
    ...
    \index{Satz von Riesz-Fr\'echet-Kolmogorov}%
    \index{kompakte Mengen in $\Lpp(\R^n)$|see{Satz von Riesz-Fr\'echet-Kolmogorov}}%
    %
