...
% 6.9
\thmmanualindex%
\begin{thDef}[Stetige/Koerzive Sesquilinearform]
    \label{vl13:def:sesquisetetigkorerziv}%
    \index{stetige Sesquilinearform}%
    \index{koerzive Sesquilinearform}%
    %
...
Fixpunktsatz:\index{Banach'scher Fixpunktsatz}\\[0.3ex]
