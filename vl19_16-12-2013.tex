...
\begin{thLemma}
    ...
    wobei $T$ \emph{vollstetig}\index{vollstetig} ist, falls gilt: Ist $\nSeq x$
...
\begin{thDef}[Spektrum]
    ...
    \begin{enumerate}[(i)]
        \item
            Die \emph{Resolventenmenge von $T$}\index{Resolventenmenge} sei
...
\begin{thBemerkung}
    \begin{enumerate}[(i)]
        ...
        \item
            ...
            $\lambda$}.\index{Eigenvektor, -wert, -raum}
            
        \item
            Wir nennen $N(\lambda\Id-T)$ den \emph{Eigenraum von $T$ zum
            Eigenwert~$\lambda$}.\index{Eigenvektor, -wert, -raum}
...
\begin{proof} \phantomsection\label{vl19:satz8.8:beweis}
    ...
    . \]
    Indem wir die Neumann'sche Reihe \pcref{vl04:neumannreihe}
