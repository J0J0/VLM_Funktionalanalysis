...
% 10.2
\thmnoindex%
\begin{thDef}[\texorpdfstring{$\Lpp$}{Lp}-Räume]
...
\emph{konjugierten Exponenten}\index{konjugierter Exponent} mit
\[ \frac{1}{p} + \frac{1}{p'} = 1  . \]
...
% 10.7
\begin{thSatz}[Satz von Fischer-Riesz]
...
% 10.9
\thmmanualindex%
\begin{thDef}[Signiertes/Komplexes Maß]
    \index{signiertes Maß}%
    \index{koplexes Maß}%
    %
