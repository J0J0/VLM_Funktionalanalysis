...
% 4.17
\begin{thDef}[Bidualraum] \label{vl07:def:JX}
...
\begin{thSatz} \label{vl07:satz4.18}
    Die Abbildung $J_X$ ist eine (im Allgemeinen nicht
    surjektive\apref{a:nichtreflI}\apref{a:nichtreflII}) lineare
...
% 4.19
\thmmanualindex%
\begin{thDef}[Reflexiver Banachraum] \label{vl07:def:reflexiv}
    \index{reflexiv}%
    %
...
% 4.22
\begin{thSatz} \label{vl07:satz4.22}
    ...
    (Im Allgemeinen ist diese Inklusion echt.\apref{a:doppelanihil})
\end{thSatz}

\pagebreak[2]
% 4.23
\begin{thDef}[Epigraph]
    Es sei $E$ eine Menge und $\phi\colon E\to \neginfinfoc
    = \R \cup \{\infty\}$ eine Abbildung. 
    \begin{enumerate}[i)]
        \item
            Es sei
...
% 4.24
\thmmanualindex%
\begin{thDef}[Unterhalbstetige Abbildung]
    \index{unterhalbstetig}%
    %
...
% 4.26
\thmmanualindex%
\begin{thDef}[Konvexe Abbildung]
    \index{konvexe Abbildung}%
    %
    Sei $X$ ein Vektorraum. Wir sagen, eine Funktion
    $\phi\colon X\to\neginfinfoc$ ist \emph{konvex}, wenn $\phi$ für alle
    $x,y\in X$ und alle $t\in\I$ die Ungleichung
...
% 4.28
\begin{thDef}[Legendre-Transformation]
    \index{konjugierte Funktion|see{Legendre-Trans\-formation}}%
    %
...
\begin{thBemerkung}\hfill
    \begin{enumerate}[(i)]
        ...
        \item
            Die Young'sche Ungleichung\index{Young'sche Ungleichung} \pcref{vl03:young}
